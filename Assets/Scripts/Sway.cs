...
public class Sway : MonoBehaviour
{
    ...
    private void updateSway()
    {
        ...
        Quaternion t_xAngleAdjustment = Quaternion.AngleAxis(-t_xLookInput * 3.1f, Vector3.up);
        Quaternion t_yAngleAdjustment = Quaternion.AngleAxis(t_yLookInput * 3.1f, Vector3.right);
